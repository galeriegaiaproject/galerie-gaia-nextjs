...
const Image = ({ min = true, trace = true, src = '', alt = '', source = 'high', ...props }) => (
  <span css={[props.css, Image.styles.element]}>
    ...
    {trace && (
      <FadeInImage
        {...props}
        src={fromFilesystem2S3(src, 'trace')}
        alt={alt}
...
const UIFadeInImage = ({ lazy, ...props }) => {
...
const FadeInImage = memo(UIFadeInImage)
